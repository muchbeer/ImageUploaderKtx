...
class UploadUtility(activity: Activity) {
    ...
    var serverURL: String = "https://muchbeer.ngrok.io/family/UploadToServer.php"
    var serverUploadDirectoryPath: String = "https://muchbeer.ngrok.io/family/uploads/"
...
/*    fun uploadFile(sourceFileUri: Uri, uploadedFileName: String? = null) {
        ...
        *//*
        ...
        This is used to convert your Uri object into the File object. But if you already have a
        File reference you can remove this overloaded method. Otherwise copy URIPathHelper utility
        class from the following link.
         *//*
        ...
        Thread {
            ...
            try {
                ...
                if (response.isSuccessful) {
                    ...
                    Log.e("UploadUtility", "failed error is : ${response.message}")
                    showToast("File uploading failed")
                }
            } catch (ex: Exception) {
                ex.printStackTrace()
                Log.e("File upload", "failed error is : ${ex.message}")
                showToast("File uploading failed")
            }
